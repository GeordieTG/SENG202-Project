...
/**
 * Custom exception to be thrown when illegal
 * access of a singleton instance is requested.
 * In this case when we are trying to
 * create an instance when one already exists.
 */
